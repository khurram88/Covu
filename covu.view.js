...
CoVu.View={
	...
	showNotificationCount : function()
	{
		try
		{
			...
			if(CoVu.Plugin.browser=='Chrome')
			{
				...
				if(popups!=0)
				{
					popups.CoVu.Popup.showNotificationCount();
				}
			}
			else if(CoVu.Plugin.browser=='Firefox')
			{
	...
	show_past_act_onsessionclosed : function ()
	{
		...
		try
		{
			...
			if(CoVu.Plugin.browser=='Chrome')
			{
				...
				if(popups!=0)
				{
					popups.CoVu.Popup.past_activity();
				}
				else
				{
					popups.CoVu.Popup.past_activity();
	...
	showHome : function ()
	{
		try
		{
			...
			if(CoVu.Plugin.browser=='Chrome')
			{
				//BACKGROUND.CoVu.Plugin.customalert("12313131");
			...
			if(url!=null)
			{
				...
				if(CoVu.Document.follow_url!=current_url)
				{
					...
					else
					{
						if(id=='' || id==null)
						{
							CoVu.Document.url_sender_name="Guest";
							CoVu.Document.url_sender_id="Guest";
						}
						else
						{
